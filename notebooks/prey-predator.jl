...
# ╔═╡ 8c3d2706-ed82-4a9e-8105-bf7864308d83
md"""
# Modelling predator-prey relations
"""

# ╔═╡ cce44a92-9879-4a9c-8cbd-9b3d1f62b0f8
f(🐛, 🐞; α, β, K) = α * 🐛 * (1 - 🐛 / K) - β * 🐛 * 🐞

# ╔═╡ 8ed64fad-ee0e-4eb4-a901-bacdd53c78c8
g(🐛, 🐞; δ, γ) = - δ * 🐞 + γ * 🐛 * 🐞

# ╔═╡ 47c648aa-0989-4d70-ad4a-0ed85a6555d8
🐛₀, 🐞₀ = (10.0, 10.0)

# ╔═╡ 3c58a1f1-6298-4028-999e-a82e90dcbdfb
tend = 50.0

# ╔═╡ 0746aaaf-c322-4ad3-b969-94e1b3978be7
md"K: $(@bind K Slider(1:100.0:10_000.0, default=1000, show_value=true))"

# ╔═╡ dcbd2cbc-45b4-488c-a328-482fc57381f4
function preypred!(du, (🐛, 🐞), (α, β, δ, γ), t)
	du[1] = f(🐛, 🐞; α, β, K)
	du[2] = g(🐛, 🐞; δ, γ)
end

# ╔═╡ d7766dc3-e60c-45e4-8438-f5a08b54d7a2
md"α: $(@bind α Slider(0.1:0.1:4.0, default=1.1, show_value=true))"

# ╔═╡ 2736253b-1ae4-4376-92e5-1e7181affacc
md"β: $(@bind β Slider(0.1:0.1:4.0, default=0.4, show_value=true))"

# ╔═╡ 3f6a988f-f19b-4546-80b2-42612c1563e4
md"δ: $(@bind δ Slider(0.1:0.1:4.0, default=0.4, show_value=true))"

# ╔═╡ 794b6c5e-d304-4a87-b63c-7d52328dfe14
md"γ: $(@bind γ Slider(0.1:0.1:4.0, default=0.1, show_value=true))"
...
quiver([x for x in 0:100:K for y in 0:100:K/3],
		[y for x in 0:100:K for y in 0:100:K/3],
		quiver=(x,y)->[f(x,y;α,β,K), g(x,y;δ,γ)]/7K,
		title="phase plot prey-predator", xlabel="prey", ylabel="predators")

# ╔═╡ 75c72563-f055-4a58-b239-87bda4cb48b4
